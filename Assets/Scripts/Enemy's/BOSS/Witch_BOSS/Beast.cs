...
public class Beast : MonoBehaviour {
	...
	{
		points = 250 * (BossMultiplicator.Multiplicator - 2); //* BossMultiplicator.Multiplicator + 1;
		price = 135 * (BossMultiplicator.Multiplicator - 2); //* BossMultiplicator.Multiplicator + 1;
		max_health = 550 * (BossMultiplicator.Multiplicator - 2);//400 * BossMultiplicator.Multiplicator + 1;
		speed = 1.7f;
		target = -1.0f;
		dmg = 90 * (BossMultiplicator.Multiplicator - 2); //* (BossMultiplicator.Multiplicator + 1) ;
		dmg_taken = Data.heroDmg;
