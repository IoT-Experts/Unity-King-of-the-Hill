...
public class Tree_BOSS : MonoBehaviour {
	...
	public EnemyPoolManager beast_spawner;
	...
	{
		points = 350 * (BossMultiplicator.Multiplicator - 3); //* BossMultiplicator.Multiplicator + 1;
		price = 300 * (BossMultiplicator.Multiplicator - 3); //* BossMultiplicator.Multiplicator + 1;
		max_health = 1600 * (BossMultiplicator.Multiplicator - 3);//400 * BossMultiplicator.Multiplicator + 1;
		speed = 0.9f;
		target = 4.5f;
		dmg = 0 * (BossMultiplicator.Multiplicator - 3); //* (BossMultiplicator.Multiplicator + 1) ;
		dmg_taken = Data.heroDmg;
	...
	//	Data.instance.CastleDmg(dmg);
		beast_spawner.LaunchEnemy(spawn_pos.position);
		PlayAttackMusic();
	}
